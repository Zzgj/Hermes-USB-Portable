...
export const taskCapabilityCopy={card:'本轮能力卡片 ID',fingerprint:'提交时核验的方法指纹',verification:'业务验证',unverified:'未取得独立业务验证证据；模型回复和工具调用结束不会自动改变此状态。',export:'下载任务观测报告',exportHelp:'手动下载当前页签最多 100 轮的状态快照（上限 256 KiB）。包含会话 ID、卡片 ID、方法指纹及工具名称/状态，不含对话正文、输入参数、工具结果或令牌。报告不是可信验证证书；分享前仍需核对标识信息。',exportError:'无法导出报告：记录可能超限。没有上传任何内容。'};
