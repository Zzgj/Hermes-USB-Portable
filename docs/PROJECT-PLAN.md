...
| 项目 | 已有证据 | 仍需完成 |
|---|---|---|
| P0-07 更新/恢复 | 官方更新成功及双方回执；外壳安装备份 | 外壳回退自动化与内核失败恢复边界不能混为一谈；内核整套回退仍未证明 |
...
| P0-12 便携性 | E/F 迁移、NTFS、换电脑 Web 收发成功 | 旧目录分层诊断与恢复会话处理；新修复合并验收 |
| P0-13 宿主审计 | Cua 外部包、旧 E 盘 Gateway 任务归属已确定 | 明确可选组件边界，不宣称全功能无宿主落地 |
| P0-14 交付 | 回归 CI、脱敏报告、备份目录清单 | RC2 独立版本名、完整文档、集中验收清单 |
