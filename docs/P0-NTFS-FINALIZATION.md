...
- Ctrl+C can return to the outer batch prompt. A dedicated managed Web stop
  action is still outstanding; port closure alone is not a process-tree audit.
...
1. Run native Windows PowerShell 5.1/7 regression tests for these changes.
