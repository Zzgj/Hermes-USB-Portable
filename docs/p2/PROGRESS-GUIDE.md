...
用户要求暂停新功能，先定向审查 dff159bed2c275d1b6a9c7c0c04c5b7bddf58bda。
基于 8fe9843 的隔离修复已覆盖证据投影/不授信、存储拒绝、更新兼容门禁、恢复风险与夹具认证盲区；
用户随后授权修复并推送：补丁已应用到 feat/portable-initializer，原开发工作区复跑 172 项自动回归、16 组件检查和构建通过。
